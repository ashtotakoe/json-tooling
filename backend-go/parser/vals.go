...
var primitiveTypes = []valType{valTypeNumber, valTypeBool, valTypeString}
...
func (v *val) add(child any) error {
	...
	return errors.New("append operation is not suported on this type " + string(rune(v.ValueType)))
}
